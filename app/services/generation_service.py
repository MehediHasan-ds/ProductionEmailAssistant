...
can never hold a request open beyond the configured budget.
"""
...
class GenerationService:
    ...
    async def generate(self, request: GenerateRequest, agent: EmailAgent) -> AgentResult:
        scenario = Scenario(
            id="adhoc",
            category="adhoc",
            ...
            tone=request.tone,
            reference_email=ReferenceEmail(subject="", body=""),
        )
